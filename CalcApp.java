// Inicialização e Design da Calculadora
...
public class CalcApp {
	...
	// Realiza a Criação da Aplicação
   ...
   // Inicia o Jframe
	...
	private void initialize() {
		...
		frmCalculator.setTitle("Ultremare Calc");
		frmCalculator.setType(Type.UTILITY);
		frmCalculator.setBounds(100, 100, 350, 410);
		frmCalculator.setSize(310, 400);
		...
		display.setText("0");
		display.setFont(new Font("", Font.PLAIN, 30));
		display.setHorizontalAlignment(SwingConstants.RIGHT);
		display.setBounds(6, 9, 278, 67);
